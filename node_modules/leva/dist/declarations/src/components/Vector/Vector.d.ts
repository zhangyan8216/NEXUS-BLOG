...
export declare const Container: import("@stitches/react/types/styled-component").StyledComponent<"div", {
    withLock?: boolean | "true" | undefined;
...
export declare function Vector<T extends Record<string, number>>({ value, onUpdate, settings, innerLabelTrim, }: VectorProps<T>): React.JSX.Element;
